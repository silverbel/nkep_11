				...
				<section class="awe-section">
					<div class="container">
						...
						<div class="page-title pb-40">
							<h2 class="page-title__title">íìì¤ ì í</h2>
							<p class="page-title__text">íìì¤ ì íí´ì£¼ì¸ì.</p>
											...
											<div class="work"><a href="blog-detail.jsp">
													...
													<div class="hoverbox ef-slide-bottom light">
														...
														<div class="hb_front"><!--<img src="https://images.pexels.com/photos/807034/pexels-photo-807034.jpeg?w=1260&amp;h=750&amp;auto=compress&amp;cs=tinysrgb" alt=""/>-->
																				<img src="./assets/img/works/discuss.jpg"/>
														</div><!-- End / hb_front -->
														
														
														<!-- hb_back -->
														<div class="hb_back">
															<h2 class="work__title">íìì¤1</h2><span class="work__text">View detail</span>
														</div><!-- End / hb_back -->
										...
										<div class="grid-item__content-wrapper">
											...
											<div class="work"><a href="blog-detail.jsp">
													...
													<div class="hoverbox ef-move-top light">
														...
														<!-- hb_back -->
														<div class="hb_back">
															<h2 class="work__title">íìì¤2</h2><span class="work__text">View detail</span>
														</div><!-- End / hb_back -->
										...
										<div class="grid-item__content-wrapper">
											...
											<div class="work"><a href="blog-detail.jsp">
													...
													<div class="hoverbox ef-slide-right light">
														...
														<!-- hb_back -->
														<div class="hb_back">
															<h2 class="work__title">íìì¤3</h2><span class="work__text">View detail</span>
														</div><!-- End / hb_back -->
										...
										<div class="grid-item__content-wrapper">
											...
											<div class="work"><a href="blog-detail.jsp">
													...
													<div class="hoverbox ef-slide-left light">
														...
														<!-- hb_front -->
														<div class="hb_front"><img src="./assets/img/works/discuss.jpg" alt=""/>
														</div><!-- End / hb_front -->
														
														
														<!-- hb_back -->
														<div class="hb_back">
															<h2 class="work__title">íìì¤4</h2><span class="work__text">View detail</span>
														</div><!-- End / hb_back -->
