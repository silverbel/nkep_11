						...
						<div class="panel-body">
							<c:forEach var="mtRoom" items="${meetRoomList}"
								...
								<div class="col-xs-6 col-md-4 text-center">
									 <img
										src=<c:url value="/getByteWorkSpaceImage/${mtRoom.mtSeq}"/>
									...
									주소 :
									<c:out value="${mtRoom.mtSize}" />
									<br> 전화번호 :
									<c:out value="${mtRoom.mtPrice}" />
									<br>
									<br> <a href="/modifyWorkSpaceForAdminForm.do?workSeq=${mtRoom.workSeq }" class="btn btn-default">수정</a>&nbsp;&nbsp;
