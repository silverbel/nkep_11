   ...
   <div class="page-wrap" id="root">
      ...
      <div class="wil-content">
         ...
         <section class="awe-section">
            <div class="container">
               ...
               <div class="page-title pb-40">
                  ...
                  <p class="page-title__text"><c:choose>
                  <c:when test="${complete != '' || complete ne null }">
                     <c:out value="${complete }"/>! 예약이 완료되었습니다.
                  </c:when>
                  <c:when test="${complete eq null || complete == '' }">
                  예약이 확정되기 위해서 승인절차를 기다려주세요.
                  </c:when>
                  </c:choose></p>
        ...
        <div class="col-lg-12" style="background:white; box-shadow: 0 2px 92px 0 rgba(0, 0, 0, .18);">
          ...
          <!-- Title -->
          <h1 class="mt-4 masthead" style="background: #3DB7CC;" align="center" >
          <c:choose>
          <c:when test="${complete != '' || complete ne null }">
                     <c:out value="${complete }"/>! 예약이 완료되었습니다.
                  </c:when>
          ...
          <div class="col-lg-12 text-center">
                ...
                <c:choose>
                <c:when test="${complete != '' || complete ne null }">
                     <h3><c:out value="${complete }"/>! 예약이 완료되었습니다.</h3>
                  </c:when>
                  <c:when test="${complete eq null || complete == '' }">
