				...
				<section class="awe-section">
					<div class="container">
						...
						<div class="page-title pb-40">
							<h2 class="page-title__title">회의실 선택</h2>
							<p class="page-title__text">회의실 선택해주세요.</p>
										...
										<div class="grid-item__content-wrapper">
											...
											<div class="work"><a href="blog-detail.jsp">
													...
													<div class="hoverbox ef-slide-bottom light">
														...
														<!-- hb_back -->
														<div class="hb_back">
															<h2 class="work__title">회의실1</h2><span class="work__text">View detail</span>
														</div><!-- End / hb_back -->
										...
										<div class="grid-item__content-wrapper">
											...
											<div class="work"><a href="blog-detail.jsp">
													...
													<div class="hoverbox ef-move-top light">
														...
														<!-- hb_back -->
														<div class="hb_back">
															<h2 class="work__title">회의실2</h2><span class="work__text">View detail</span>
														</div><!-- End / hb_back -->
										...
										<div class="grid-item__content-wrapper">
											...
											<div class="work"><a href="blog-detail.jsp">
													...
													<div class="hoverbox ef-slide-right light">
														...
														<!-- hb_back -->
														<div class="hb_back">
															<h2 class="work__title">회의실3</h2><span class="work__text">View detail</span>
														</div><!-- End / hb_back -->
										...
										<div class="grid-item__content-wrapper">
											...
											<div class="work"><a href="blog-detail.jsp">
													...
													<div class="hoverbox ef-slide-left light">
														...
														<!-- hb_back -->
														<div class="hb_back">
															<h2 class="work__title">회의실4</h2><span class="work__text">View detail</span>
														</div><!-- End / hb_back -->
