				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="container">
								<form action="modifyMeetingRoomForAdmin.do?mtSeq=${meetingRoomDTO.mtSeq }"
									enctype="multipart/form-data" method="post">
									<div class="row">
										<div class="col-25">
											<label for="fname">근무지</label>
										</div>
										<div class="col-75">
											<input type="text" name="workName" value="${meetingRoomPlusWSNameDTO.workName }" class="form-control" readonly/>
										</div>
									</div>
									<br>
									<br>
									<div class="row">
										...
										<div class="col-75 form-inline text-left">
											<input type="text" class="form-control" name="mtName" id="mtName" value="${meetingRoomPlusWSNameDTO.mtName}"/>
										</div>
									</div>
									<br>
									<div class="row">
										...
										<div class="col-75 form-inline text-left">
											<input type="text" class="form-control" name="mtAvail" id="mtAvail" value="${meetingRoomPlusWSNameDTO.mtAvail}"/>
										</div>
									</div>
									<br>
									<div class="row">
										...
										<div class="col-75 form-inline text-left">
											<input type="text" class="form-control" name="mtSize" id="mtSize" value="${meetingRoomPlusWSNameDTO.mtSize}"/>
										</div>
									</div>
									<br>
									<div class="row">
										...
										<div class="col-75 form-inline text-left">
											<input type="text" class="form-control" name="mtPrice" id="mtPrice" value="${meetingRoomPlusWSNameDTO.mtPrice}"/>
										</div>
									</div>
									<br>
									<div class="row">
									...
									<div class="row">
										...
										<div class="col-75">
											<textarea id="mtDescription" name="mtDescription"
												...
												class="form-control">${meetingRoomPlusWSNameDTO.mtDescription}</textarea>
										</div>
									</div>
									<br>
